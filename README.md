...
<div id="message">Wrong option. I could do this all day! 😉</div>
...
function yesClicked(){
  ...
  msg.innerHTML='BEST. DECISION. EVER.<br>Thanks for choosing to be my valentine, Chilu!!! 🥰';
...
noBtn.addEventListener("click", ()=>{
  ...
  // 🔊 FIRST BEEP — EXACTLY WHEN 5 APPEARS
  beep();
